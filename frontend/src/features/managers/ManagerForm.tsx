...
} from "@/features/managers/manager.schema";
...
interface ManagerFormProps {
  ...
  submitLabel?: string;
  isEdit?: boolean;
  onSubmit: (values: ManagerFormValues) => Promise<void> | void;
}
...
export default function ManagerForm({
  ...
  const schema = useMemo(() => buildManagerSchema({ isEdit }), [isEdit]);
  ...
  const onValidSubmit = async (values: ManagerFormValues) => {
    setSubmitting(true);
    try {
